...
const formDataCollection =
  props.modalData.importMeetingData?.map((meeting) => {
    const startEndDifference =
...
<template>
  <ModalTemplate :actions="actions" title="Import Meetings from Outlook">
    ...
    >
      ...
      <div class="mb-3 form-check">
        <label class="form-check-label" for="add-timer-cb"
